...
# 导入数据
dataset_path = "./2019dailyonlyquality.xlsx"
...
for i in range(datanum):
    ...
    # df_insert = pd.DataFrame({'input': Inputlist, 'TNe': rawdata.loc[i+lookback]['TNe'])
...
# traindata[0][0][0] = train_data.loc[208]['input'][0][0]  # 这里不采用loc，而用iloc，因为index的数据已经搞乱，所以对应不上
